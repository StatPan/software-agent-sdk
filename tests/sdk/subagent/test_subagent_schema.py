...
# _resolve_env_vars and _resolve_env_vars_deep tests removed —
# env-var expansion in MCP server configs is now handled by
# expand_mcp_variables (tested in tests/sdk/mcp/test_config.py).
